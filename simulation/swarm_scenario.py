...
SWARM_BENCHMARK_PROFILES: Dict[str, SwarmBenchmarkProfile] = {
    "baseline": SwarmBenchmarkProfile(
        ...
        tolerance=1e-6,
        envelope=SwarmBenchmarkEnvelope(
            min_separation_min=1.5,
            p05_separation_min=4.0,
            mean_tracking_error_max=20.0,
            p75_tracking_error_max=25.0,
            max_tracking_error_max=40.0,
            mean_speed_max=7.8,
            p90_speed_max=8.1,
        ),
    ),
    "crosswind": SwarmBenchmarkProfile(
        ...
        envelope=SwarmBenchmarkEnvelope(
            ...
            p05_separation_min=6.0,
            mean_tracking_error_max=18.0,
            p75_tracking_error_max=20.0,
            max_tracking_error_max=33.0,
            mean_speed_max=7.8,
            p90_speed_max=8.1,
        ),
    ),
    "gusty": SwarmBenchmarkProfile(
        ...
        tolerance=1e-6,
        envelope=SwarmBenchmarkEnvelope(
            min_separation_min=1.3,
            p05_separation_min=1.8,
            mean_tracking_error_max=20.0,
            p75_tracking_error_max=25.0,
    ...
    "tight_ring": SwarmBenchmarkProfile(
        ...
        tolerance=1e-6,
        envelope=SwarmBenchmarkEnvelope(
            min_separation_min=0.15,
            p05_separation_min=2.5,
            mean_tracking_error_max=12.0,
            p75_tracking_error_max=14.0,
            max_tracking_error_max=16.0,
            mean_speed_max=7.8,
            p90_speed_max=8.1,
        ),
    ),
